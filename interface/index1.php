				...
				<div class="page-header">
					<div class="row">
						<div class="col-sm-12 mt-5">
							<h3 class="page-title mt-3">Good Morning <?php
								 $_SESSION["email"];	
							$sql = "SELECT * FROM utilisateur WHERE email=:email";
							$stmt = $bdd->prepare($sql);
							$stmt->bindParam(':email', $_SESSION["email"]);
							...
							<div class="card-body">
								<div class="dash-widget-header">
									<div>
										...
										<h6 class="text-muted">My total visits</h6> </div>
									<div class="ml-auto mt-md-3 mt-lg-0"> <span class="opacity-7 text-muted"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="30" viewbox="0 0 24 24" fill="none" stroke="#009688" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye">
  <path d="M22.4 11c-.7-.9-3.2-4-10.4-4-7.2 0-9.7 3.1-10.4 4-.3.4-.3.9 0 1.3.7.9 3.2 4 10.4 4 7.2 0 9.7-3.1 10.4-4 .3-.4.3-.9 0-1.3zM12 15.5c-2.2 0-3.9-1.8-3.9-4s1.7-4 3.9-4 3.9 1.8 3.9 4-1.7 4-3.9 4zm0-6.5c-1 0-1.9.8-1.9 2s.9 2 1.9 2 1.9-.8 1.9-2-.9-2-1.9-2z"/>
</svg></span> </div>
								</div>
							</div>
						</div>
							...
							<div class="card-body">
								<div class="dash-widget-header">
									<div>
										...
										<h6 class="text-muted">My total reservation</h6> </div>
					...
					<div class="col-xl-3 col-sm-6 col-12">
						<div class="card board1 fill">
							<div class="card-body">
								<div class="dash-widget-header">
									<div>
										<h3 class="card_widget_header">700DT</h3>
										<h6 class="text-muted">Expenses</h6> </div>
					...
					<div class="col-xl-3 col-sm-6 col-12">
						<div class="card board1 fill">
							<div class="card-body">
								<div class="dash-widget-header">
									<div>
										<h3 class="card_widget_header">30</h3>
										<h6 class="text-muted">Comments</h6> </div>
										<div class="ml-auto mt-md-3 mt-lg-0">
  <span class="opacity-7 text-muted">
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#009688" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-message-square">
      <path d="M19 5h-14a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h9l5 5V7a2 2 0 0 0-2-2z"></path>
    </svg>
  </span>
							  </div></div></div>
							</div>
					...
					<div class="row align-items-center">
						<div class="col">
							<div class="mt-5">
								<h4 class="card-title float-left mt-2">My latest payments</h4>
